      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: (){
            Provider.of<GameHelper>(context,listen: false).confirmText(context);
                       ...
                       children: [
                         Row(
                           children: [
                             ...
                             Container(
                               child: Text(" Score: $score%",style: TextStyle(color: Colors.yellow,fontSize: 30),)
                             ),
                           ],
                         ),
                       ],
